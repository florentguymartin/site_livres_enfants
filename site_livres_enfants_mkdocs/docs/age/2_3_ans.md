...
![Screenshot](../img/un_bisou_pour_mon_frere.jpg){ width="100" }
...
![Screenshot](../img/mit_maus_im_wald.jpg){ width="100" }

On suit une souris dans ses bois de Janvier à Décembre, avec de très belles illustrations.


## Le secret (*Anaïs Vaugelade*)
...
![Screenshot](../img/anna_et_le_gorille.jpg){ width="100" }

Une petite fille, un anniversaire, un gorille.


## Le garçon, le chien et la mer (*Anthony Browne*)

![Screenshot](../img/le_garcon_le_chien_et_la_mer.jpg){ width="100" }

Un petit frère qui s'ennuie sans son grand frère. Un chien qui ne demande qu'à sortir. Une belle morale.


## Le tunnel (*Anthony Browne*)

![Screenshot](../img/le_tunnel.jpg){ width="100" }

Une soeur et un grand frère qui ne s'entendent pas. Une soeur qui est introvertie et se fait chambrer par son frère. Mais c'est la grande soeur qui surmonte sa peur et va sauver son frere. Comme souvent avec Anthony Browne l'arrière-plan est truffés de détails extra-ordinaires.


## Ourson et la ville (*Anthony Browne*)

![Screenshot](../img/ourson_et_la_ville.jpg){ width="100" }
...
![Screenshot](../img/bebe_ventre.jpg){ width="100" }
...
![Screenshot](../img/bist_du_der_fruehling.jpg){ width="100" }
...
![Screenshot](../img/les_histoires_du_soir_de_litouho.jpg){ width="100" }

Une histoire sur les vertus de savoir lire tout seul. Et sur la filouterie de maître hibou !Merci Matou !


## La brouille (*Claude Boujon*)

![Screenshot](../img/la_brouille.jpg){ width="100" }
...
![Screenshot](../img/le_petit_bateau_de_petit_ours.jpg){ width="100" }

Une histoire de barques qui finissent par être trop petites quand on grandit trop. Mignon et bon enfant.


## Le tapis en peau de tigre (*Gerald Rose*)

![Screenshot](../img/le_tapis_en_peau_de_tigre.jpg){ width="100" }

Comme quoi les tigres ne sont pas toujours à envier. Mais tout en bien qui finit bien !


## Boucle d'or et les trois ours (*Gerda Muller*)

![Screenshot](../img/boucle_d_or_et_les_trois_ours.jpg){ width="100" }
...
![Screenshot](../img/ligne_135.jpg){ width="100" }
...
![Screenshot](../img/olivia_reine_des_princesses.jpg){ width="100" }

Toutes les petites filles rêvent de princesse. Se pamer devant le preux et fort chevalier. Être habillées toutes pareilles avec des tutus roses. Euh... vraiment ?! En tout cas pas Olivia !Merci Olivia !


## Un appel dans la nuit (*Jane Yolen*)

![Screenshot](../img/un_appel_dans_la_nuit.jpg){ width="100" }

Partir la nuit observer le hibou. Une belle histoire et de jolies illustrations.


## Je te guérirai, dit l'ours (*Janosch*)

![Screenshot](../img/ich_mach_dich_gesund_sagte_der_baer.jpg){ width="100" }

Le tigre est malade et son ami ours lui promet de le guérir. Un beau livre sur l'amitié. Un classique en Allemagne.
...
![Screenshot](../img/au_lit_petit_lapin.jpg){ width="100" }
...
## Les souris à la plage (*Kazuo Iwamura et Haruo Yamashita*)

![Screenshot](../img/les_souris_a_la_plage.jpg){ width="100" }
...
![Screenshot](../img/occupe.jpg){ width="100" }
...
![Screenshot](../img/petit_bond_est_amoureux.jpg){ width="100" }
...
![Screenshot](../img/prout_de_mammouth.jpg){ width="100" }
...
![Screenshot](../img/grigrigredin_menufretin.jpg){ width="100" }
...
Un super livre avant un voyage en train.


## La belle lisee poire du prince de Motordu (*Pef*)

![Screenshot](../img/la_belle_lisse_poire_du_prince_de_motordu.jpg){ width="100" }
...
![Screenshot](../img/sommer_wimmelbuch.jpg){ width="100" }
...
![Screenshot](../img/caca_boudin.jpg){ width="100" }
...
![Screenshot](../img/la_vague.jpg){ width="100" }
...
![Screenshot](../img/die_torte_ist_weg.jpg){ width="100" }
